...
class ScreenshotPlugin implements Plugin<Project> {
    ...
    private static void applyJava(ScreenshotExtension extension, Project project) {
    ...
    private static void applyAndroid(ScreenshotExtension extension, Project project) {
    ...
    private static void setupConfigExecutions(
        ...
        if (config.executions.isEmpty()) {
            config.executions.add(new ScreenshotPluginConfiguration("main", objectFactory))
        }

        for (ScreenshotPluginConfiguration execution : config.executions) {
