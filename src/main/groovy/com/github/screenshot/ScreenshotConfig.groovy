...
@ToString
class ScreenshotConfig implements GenerationConfig {
    ...
    ScreenshotConfig(ScreenshotExtension extension, ScreenshotPluginConfiguration configuration, Provider<Directory> targetDirectory, ConfigurableFileCollection sourceFiles) {
    ...
    private static <C> Class<C> findClass(String className) {
        return (Class<C>) Class.forName(className, true, ScreenshotConfig.class.classLoader)
    }
}
